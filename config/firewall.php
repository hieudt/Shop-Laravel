...
return [
    ...
    'notifications' => [
        ...
        'message' => [
            ...
            'request_count' => [
                'title' => 'Cảnh báo flood',

                'message' => 'Hệ thống nhận được %s lượt truy cập trong %s giây. Thời gian bắt đầu: %s',
            ],

            'uri' => [
                'title' => 'Vị trí truy cập ',
            ],
        ...
        'from' => [
            'name' => 'SHOP CỬA HÀNG HIẾU MAI',

            'address' => 'hieumai@shop.vn',
