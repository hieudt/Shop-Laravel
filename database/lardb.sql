...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th4 11, 2019 lúc 09:26 PM
...
CREATE TABLE `Bill` (
  ...
  `enableCustomAddress` int(11) NOT NULL COMMENT '0 :  Địa chỉ user 1 : địa chỉ info ship',
...
INSERT INTO `Bill` (`id`, `status`, `statusPay`, `PayMethod`, `id_user`, `id_coupon`, `id_infoship`, `id_shipper`, `enableCustomAddress`, `TotalMoney`, `created_at`, `updated_at`) VALUES
(1, 2, 1, 0, 6, NULL, NULL, 1, 0, 2500000, NULL, NULL),
(2, 0, 0, 0, 6, NULL, NULL, 1, 0, 125000, NULL, NULL);
...
(2, 'U23VN', 50, 25000000, '2019-04-24 00:00:00', 'Mừng U23VN', 'https://bloggiamgia.vn/wp-content/uploads/2018/04/mã-giảm-giá-shopee..png', 0, 'Đội tuyển vô địch', '2019-04-05 06:44:11', '2019-04-05 06:44:11'),
...
(5, 'CODETIEMNANG', 5, 1500000, '2019-05-09 00:00:00', 'MÃ tiềm năng', 'https://magiamgia.com/wp-content/uploads/2015/12/ma-giam-gia-facebook-image-default.png', 2, 'MÃ tiềm năng', '2019-04-10 10:38:21', '2019-04-10 10:38:21'),
...
(75, 24, 6, 2, 'sfdsd', 5, '2019-04-04 09:21:05', '2019-04-04 09:21:05'),
(76, 24, 1, 2, 'dsfds', 4, '2019-04-04 09:21:05', '2019-04-04 09:21:05'),
...
INSERT INTO `Shipper` (`id`, `name`, `fee`, `Time`, `Display`, `created_at`, `updated_at`) VALUES
(1, 'GiaoHangNhanh', 15000, '4h', 1, NULL, NULL);
...
(1, 'Dương Trung Hiếu', 'rogteamvn@gmail.com', 'users/default.png', 'hoàng liệt, hoàng mai,hà nội', '1636001860', '$2y$10$AFONSnQeqg/dHHE65pV0q.qzgFjXjMuLluPsl4uQ9.wehO/xJ/bbO', 'BTrrVnD3AYjpyDObUsgYtyJgtK7eqIfhZEn3E1lbkO6DqnyhYuRUJyOUG6Ti', '{"locale":"en"}', NULL, '2019-04-10 10:37:22'),
...
(6, 'maixinhs', 'mai@adm.vn', 'default.png', 'maimai', '037777777777', '$2y$10$GIf.wJRBT.so4uyNfz.kD.D5B7jaGN.BCPLuk6u8AeqsPXZruR1uC', NULL, NULL, '2019-04-07 14:15:18', '2019-04-09 14:08:14'),
...
(11, 'Lê Hoàng Mai', 'lehoangmai@mai.vn', 'default.png', 'tretretrưeẻ', '5435435423', '$2y$10$rSnYTc.Kkmr1Eg2mhkrwduQGfiFdAOcIdqLTZ4GaGepDFdq50CI9C', NULL, NULL, '2019-04-11 13:50:27', '2019-04-11 13:50:27');
