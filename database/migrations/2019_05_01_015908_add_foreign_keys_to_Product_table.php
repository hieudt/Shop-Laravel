...
class AddForeignKeysToProductTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->foreign('id_brand', 'product_id_brands_foreign')->references('id')->on('brands')->onUpdate('RESTRICT')->onDelete('RESTRICT');
	...
	public function down()
	{
		Schema::table('Product', function(Blueprint $table)
		{
			$table->dropForeign('product_id_brands_foreign');
