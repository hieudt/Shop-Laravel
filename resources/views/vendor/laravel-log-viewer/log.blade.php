...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      <h1><i class="fa fa-calendar" aria-hidden="true"></i> Quản lý lịch sử</h1>
      <p class="text-muted"><i>by ROGTeam</i></p>
      ...
      <div class="p-3">
        @if($current_file)
          ...
          <a id="clean-log" href="?clean={{ \Illuminate\Support\Facades\Crypt::encrypt($current_folder ? $current_folder . "/" . $current_file : $current_file) }}{{ ($current_folder) ? '&f=' . \Illuminate\Support\Facades\Crypt::encrypt($current_folder) : '' }}">
            <span class="fa fa-sync"></span> Dọn file
          </a>
          -
          ...
          @if(count($files) > 1)
            ...
            <a id="delete-all-log" href="?delall=true{{ ($current_folder) ? '&f=' . \Illuminate\Support\Facades\Crypt::encrypt($current_folder) : '' }}">
              <span class="fa fa-trash-alt"></span> Xóa toàn bộ file
            </a>
          @endif
        @endif
      </div>
...
<script>
  $(document).ready(function () {
    ...
    $('#delete-log, #clean-log, #delete-all-log').click(function () {
      return confirm('Vui lòng xác nhận thao tác này');
    });
  });
</script>
</body>
