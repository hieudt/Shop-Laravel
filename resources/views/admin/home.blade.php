  ...
  <script id="code">
    function init() {
      ...
      var nodeDataArray = [
        ...
        { key: 4, boss:1, name: "Quản Lý Giỏ Hàng"},
        {key: 5 , boss:1, name: "Quản lý TT Người Dùng"},
        ...
        {key: 11 , boss:5, name: "Xem Thông tin",title:"Đã Xong",},
        {key: 12 , boss:5, name: "Xem Lịch sử hóa đơn",title:"Đã Xong",},
        {key: 56 , boss:1, name: "Tìm kiếm Sản Phẩm"},
        ...
        {key: 60 , boss:56, name: "Tìm theo tên"},
