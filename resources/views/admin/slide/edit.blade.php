                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="txtTitle" value="{{$data->title}}" placeholder="Nhập tiêu đề slide">
                        </div>
                        <div class="form-group">
                            <label for="Name Product">Nội Dung</label>
                            <input type="text" class="form-control" name="txtContent" value="{{$data->content}}" placeholder="Nhập nội dung slide">
                        </div>
                        <div class="form-group">
                            <label for="Name Product">Đường Dẫn</label>
                            <input type="text" class="form-control" name="txtUrl" value="{{$data->url}}" placeholder="Nhập đường dẫn slide">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <input type="file" id="Image1" name="Image1" class="dropify" data-default-file="{{url('/images/sliders/'.$data->thumbnail)}}">
                            </div>
                            <div class="form-group">
...
<script>
    ...
    var data = new FormData(this);
        $.ajax({
            ...
            method: 'POST',
            url: '{{url('admin/slide/edit/'.$data->id)}}',
            data:data,
            dataType:'JSON',
            contentType:false,
            cache:false,
