                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nameProduct" name="txtName" placeholder="Nhập tên tin tức" value="{{$data->title}}">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                ...
                                <input type="text" class="form-control form-control-sm" id="inlineFormInputGroup1" name="txtSlug" value="{{$data->slug}}" placeholder="Để trống sẽ tự tạo theo tiêu đề">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <input disabled type="file" id="Image1" name="Image1" class="dropify" data-default-file="/images/news/{{$data->thumbnail}}">
                            </div>
                            <div class="form-group">
...
<script>
    ...
    var data = new FormData(this);
        $.ajax({
            ...
            method: 'POST',
            url: '{{url('admin/news/edit/'.$data->id)}}',
            data:data,
            dataType:'JSON',
            contentType:false,
            cache:false,
