    ...
    @include('includes.cart')
        <div class="search-box popup">
            <div class="aa-input-container" id="aa-input-container">
                <input type="search" id="aa-search-input" class="aa-input-search" placeholder="Tìm kiếm sản phẩm" name="search"
                    autocomplete="off" />
...
<div class="zalo-chat-widget" data-oaid="3261362199566416167" data-welcome-message="Rất vui khi được hỗ trợ bạn!" data-autopopup="0" data-width="350" data-height="420"></div>
